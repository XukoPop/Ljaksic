    ...
    <div className="hero-content">
      <div className="hero-text">
        ...
        <div className="hero-buttons">
          ...
          <a href="https://github.com/VaultCore-Dev/VaultCore" className="download-btn" target="_blank" rel="noopener noreferrer" style={{marginLeft: '15px', backgroundColor: '#171515'}}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#ffffff" style={{marginRight: '8px'}}>
          ...
          <a href="https://discord.gg/RFjMZsjGqu" className="download-btn" target="_blank" rel="noopener noreferrer" style={{marginLeft: '15px', backgroundColor: '#5865F2'}}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#ffffff" style={{marginRight: '8px'}}>
